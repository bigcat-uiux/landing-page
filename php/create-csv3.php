 ...
 * ==================================================================
 */
if (isset($_POST['submitMinigame3'])) {
    // Collect the form data.
    $minigame = isset($_POST['minigameMg3']) ? $_POST['minigameMg3'] : '';
    $m88username = isset($_POST['m88usernameMg3']) ? $_POST['m88usernameMg3'] : '';
    $answer1 = isset($_POST['answer1Mg3']) ? $_POST['answer1Mg3'] : '';
    ...
    if (!isset($errors)) {
        ...
        $header = "Timestamp,Mini Game,M88 Username,Answer 1\n";
        // The data of the CSV.
        date_default_timezone_set('Asia/Manila');
        $data = date("Md-Y h:i:sA").",$minigame,$m88username,$answer1\n";
        ...
        $fileName = dirname(__DIR__) . "/minigame-3.csv";
