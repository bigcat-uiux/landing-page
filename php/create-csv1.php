 ...
 * ==================================================================
 */
if (isset($_POST['submitMinigame1'])) {
  // Collect the form data.
  $minigame = isset($_POST['minigameMg1']) ? $_POST['minigameMg1'] : '';
  $m88username = isset($_POST['m88usernameMg1']) ? $_POST['m88usernameMg1'] : '';
  $answer1 = isset($_POST['answer1Mg1']) ? $_POST['answer1Mg1'] : '';
  $answer2 = isset($_POST['answer2Mg1']) ? $_POST['answer2Mg1'] : '';
  $answer3 = isset($_POST['answer3Mg1']) ? $_POST['answer3Mg1'] : '';
  ...
  if (!isset($errors)) {
    ...
    $header = "Timestamp,Mini Game,M88 Username,Answer 1,Answer 2,Answer 3\n";
    // The data of the CSV.
    date_default_timezone_set('Asia/Manila');
    $data = date("Md-Y h:i:sA") . ",$minigame,$m88username,$answer1,$answer2,$answer3\n";
    ...
    $fileName = dirname(__DIR__) . "/minigame-1.csv";
