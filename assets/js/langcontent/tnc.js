...
<li>โปรโมชั่นนี้สามารถใช้ได้กับสมาชิกใหม่ 400 คนแรก ที่สมัครตั้งแต่วันที่ 1 เมษายน 2567 เวลา 00:00:00 น. ถึงวันที่ 31 กรกฎาคม 2567 เวลา 23:59:00 น. (GMT+8)</li>
<li>สมาชิกใหม่ที่เข้าเงื่อนไข จะได้รับโบนัส 300 บาท ในผลิตภัณฑ์ที่เลือกภายใน 24 - 48 ชม. หลังจากการตรวจสอบเสร็จสิ้น โดยโบนัสมียอดเดิมพันหมุนเวียน 10 เท่า
<table>
    <thead>
        <tr>
            <th>โบนัส</th>
            <th>ผลิตภัณฑ์</th>
            <th class="third-row">ยอดเทิร์น <br>(เงินฝาก+โบนัส )</th>
            <th class="fourth-row">สำหรับผู้สมัคร</th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td rowspan=4>300 บาท</td>
            <td>กีฬา</td>
            <td rowspan=4>10 เท่า</td>
            <td rowspan=4>400 คน</td>
        </tr>
        <tr>
        <td>คาสิโนสล็อต</td>
        </tr>
...
<li>สมาชิกสามารถเลือกทำรายการฝากครั้งแรกขั้นต่ำตามที่กำหนด การถอนขั้นต่ำ-สูงสุด มีรายละเอียดตามรายการด้านล่างนี้ จึงจะสามารถทำการถอนเงินได้
<table>
    <thead>
        <tr>
            <th>โบนัส</th>
