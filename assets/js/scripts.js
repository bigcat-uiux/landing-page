...
$(document).ready(function () {
  ...
  $(
    ".modals, .modals__lbox__close, .btn--modal, .modals__lbox__foot .btn, .bar.mobi"
  ).on("click", function () {
...
$("#betIdForm input").bind("keyup blur click enter", function () {
  // fires on every keyup & blur
  if ($("#betIdForm").validate().checkForm()) {
...
function saveToSessionBetId() {
  ...
  inputUsername = document.getElementById("m88usernameMg3");
  inputRecipient = document.getElementById("m88usernameMg3");
  inputContact = document.getElementById("m88usernameMg3");
  inputAddress = document.getElementById("m88usernameMg3");
  inputPostal = document.getElementById("m88usernameMg3");
  ...
  sessionStorage.setItem("recipient", inputRecipient.value);
  sessionStorage.setItem("contact", inputContact.value);
  sessionStorage.setItem("address", inputAddress.value);
  sessionStorage.setItem("postal", inputPostal.value);
...
var callLSGetItem = function () {
  ...
  var betId =
    sessionStorage.getItem("betId") !== null
      ? sessionStorage.getItem("betId")
      : "";
  var m88username =
    sessionStorage.getItem("m88username") !== null
      ? sessionStorage.getItem("m88username")
      : "";
  var recipient =
    sessionStorage.getItem("recipient") !== null
      ? sessionStorage.getItem("recipient")
      : "";
  var contact =
    sessionStorage.getItem("contact") !== null
  ...
  var address =
    sessionStorage.getItem("address") !== null
      ...
      : "";
  var postal =
    sessionStorage.getItem("postal") !== null
      ? sessionStorage.getItem("postal")
      : "";
  var remark =
    sessionStorage.getItem("remark") !== null
