  ...
  <div class="inner">
    ...
    <div class="promo__content">
      ...
      if ($_SERVER['QUERY_STRING'] === "lang=cn" || $_SERVER['QUERY_STRING'] === "lang=my") {
        $tncData = "
        <li> 活动期间：2024年3月29日至6月16日，期间内新注册的明陞M88玩家。 </li>
        <li> 活动期间所有新注册会员，可享有免费投注礼金。 </li>
        <li> 本活动限量前500位新注册玩家，获得38人民币免费投注。 </li>
        <li> 免费投注奖金只能在电竞比赛中使用。 </li>
        <li> 奖金仅可用于电竞产品中的平博电竞、沙巴电竞和雷火电竞中，系统才可认列流水计算（8倍流水）。
        列如：
        免费投注奖金：38人民币
        流水要求 = 免费投注 78 人民币 x 8 倍 = 304人民币
        </li>
        <li> 玩家必须在14天内达成指定投注额，逾期系统自动取消奖金与盈利。 </li>
        <li> 提款前，玩家必须在活动期间内存入最低存款 100 人民币，并达成1倍流水。 </li>
        <li> 若会员账号余额低于1人民币，系统将清除未完成的有效投注。 </li>
        ...
        <li> 本次活动只适用于「人民币」帐户之会员玩家。 </li>
        <li> 如果您的账户仍有未完成的有效流水要求，您将无法提款。请联系在线客服办理撤除/取消/豁免流水要求即可。 </li>
        <li> 本活动不能与明陞M88其他活动同时进行，除非特殊活动加注说明。 </li>
        <li> 注册M88 Mansion的参赛者必须年满18岁以上。  明陞M88保留随时更改、更新、修改或取消此促销活动的权利 </li>
        <li> 一般条款及规则应用于此优惠。 </li>
          ";
      }
      if ($_SERVER['QUERY_STRING'] === "lang=en" || $_SERVER['QUERY_STRING'] === "") {
        $tncData = "
        <li> The promotion starts on 29 March 2024 at 00:00 (GMT+8) untill 16 June 2024 at 23:59 (GMT+8). </li>
        <li> The Free bet is available to all new registrations during the promotion period. </li>
        <li> First 500 sign-ups will receive a $5 free bet. </li>
      ...
      if ($_SERVER['QUERY_STRING'] === "lang=id") {
        $tncData = "<li> Promosi dimulai pada 29 Maret 2024 pukul 00:00 (GMT+8) dan berakhir pada 16 Juni 2024 pukul 23:59 (GMT+8). </li>
        <li> Freebet tersedia untuk semua pendaftaran baru selama periode promosi. </li>
        <li> 500 pendaftar pertama akan menerima Freebet $5 </li>
      ...
      if ($_SERVER['QUERY_STRING'] === "lang=th") {
        $tncData = "<li> โปรโมชั่นนี้เริ่มตั้งแต่วันที่ 29 มีนาคม 2024 เวลา 00:00 น. (GMT+8) จนถึง 16 มิถุนายน 2024 เวลา 23:59 น. (GMT+8) </li>
        <li> ฟรีเบทมีให้สำหรับสมาชิกใหม่ที่ลงทะเบียนในช่วงระยะเวลาโปรโมชั่นเท่านั้น </li> 
        <li> สมาชิกที่ลงทะเบียน 500 ท่านแรก จะได้รับฟรีเบท 178 บาท </li>
      ...
      if ($_SERVER['QUERY_STRING'] === "lang=vn") {
        $tncData = "<li> Khuyến mãi có hiệu lực từ ngày 29/03/2024 lúc 00:00 (GMT+8) đến 16/06/2024 lúc 23:59 (GMT+8). </li>
        <li> Tất cả thành viên đăng ký trong thời gian diễn ra khuyến mãi hợp lệ nhận Freebet </li>
        <li> 500 thành viên đăng ký đầu tiền sẽ nhận 120 VND Freebet. </li>
        <li> Thưởng Freebet chỉ áp dụng vào các trận đấu Thể thao Điện tử.  </li>
        <li> Tiền thưởng cần trải qua 8x vòng cược tại Pinnacle, SABA, thể thao điện tử, và TF Gaming.  </li>
        Ví dụ: 
