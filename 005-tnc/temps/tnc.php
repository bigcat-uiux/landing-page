  ...
  <div class="inner">
    ...
    <div class="promo__content">
      ...
      if ($_SERVER['QUERY_STRING'] === "lang=cn" || $_SERVER['QUERY_STRING'] === "lang=my") {
        $tncData = "
        <li>活动期间：2024年3月15日至6月16日，期间内新注册的明陞M88玩家</li>
        <li> 活动期间所有新注册会员，可享有免费投注礼金。 </li>
        <li> 本活动限量前1000位新注册玩家，获得28马币免费投注。 </li>
        <li> 免费投注奖金只能在电竞比赛中使用。 </li>
        <li> 奖金仅可用于电竞产品中的平博电竞、沙巴电竞和雷火电竞中，系统才可认列流水计算（8倍流水）。
        列如：<br/>
        免费投注奖金：28 马币 <br/>
        流水要求 = 免费投注 48 马币 x 8 倍 = 224马币 
        </li>
        <li> 玩家必须在14天内达成指定投注额，逾期系统自动取消奖金与盈利。 </li>
        <li> 提款前，玩家必须在活动期间内存入最低存款  30 马币，并且达成1倍流水。 </li>
      ...
      if ($_SERVER['QUERY_STRING'] === "lang=en" || $_SERVER['QUERY_STRING'] === "") {
        $tncData = "
          <li>The promotion starts on 15 March 2024 at 00:00 (GMT+8) untill 16 June 2024 at 23:59 (GMT+8).</li>
          ...
          Example: 
          Bonus freebet : $5 
          Rollover Requirement = Bonus freebet $5 x 8 RO = $40</li>
      ...
      if ($_SERVER['QUERY_STRING'] === "lang=id") {
        $tncData = "<li> Promosi dimulai pada 15 Maret 2024 pukul 00:00 (GMT+8) dan berakhir pada 16 Juni 2024 pukul 23:59 (GMT+8). </li>
      ...
      if ($_SERVER['QUERY_STRING'] === "lang=th") {
        $tncData = "<li> โปรโมชั่นนี้เริ่มตั้งแต่วันที่ 15 มีนาคม  2024เวลา 00:00 น. (GMT+8) จนถึง 16 มิถุนายน 2024 เวลา 23:59 น. (GMT+8) </li>
      ...
      if ($_SERVER['QUERY_STRING'] === "lang=vn") {
        $tncData = "<li> Khuyến mãi có hiệu lực từ ngày 15/03/2024 lúc 00:00 (GMT+8) đến 16/06/2024 lúc 23:59 (GMT+8). </li>
        <li> Tất cả thành viên đăng ký trong thời gian diễn ra khuyến mãi hợp lệ nhận Freebet </li>
        <li> 1000 thành viên đăng ký đầu tiền sẽ nhận 120 VND freebet.   </li>
